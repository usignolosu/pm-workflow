...
> **项目路径**：`<workspace>/`
> **引入版本**：v3.0.0（2026-07-03，姊妹工作流仓库首版）→ v7.0.0（2026-09-16，合并后定稿）
> **关联契约**：`contracts/schema/kg_contract.yaml`、`contracts/schema/agent_contracts.yaml`
> **数据规模**：31 实体 / 27 文件（合并 姊妹工作流仓库 22 实体 + 本工作区演化 106 实体）
...
└── legacy/
    └── REQ-001~005/               # 姊妹工作流仓库迁入的 YAML（仅 REQ-001/002/004/005 有实体文件）
```
...
## 六、附录：从 姊妹工作流仓库迁入的关键变化

| 维度 | 姊妹工作流仓库 v3.x | 本工作区 v7.0.0 | 变化原因 |
|---|---|---|---|
